...
public class Utility {
	...
	public static void takeScreenShot(WebDriver driver,String fileName) throws IOException
	{
		...
		File dest=new File("C:\\Users\\borse\\eclipse-workspace\\PolicyBazaar\\screenShot"+fileName+".png");
	...
	public static String readDataFromExcel(int row,int cell) throws EncryptedDocumentException, IOException {
		FileInputStream myFile=new FileInputStream("C:\\Users\\borse\\OneDrive\\Desktop\\Book1.xlsx");
	...
	public static String readDataFromPropertyFile(String key) throws IOException {
		...
		FileInputStream myFile=new FileInputStream("C:\\Users\\borse\\eclipse-workspace\\selenium_test\\test.properties");
		prop.load(myFile);
